              ...
              >
                ...
                <p style={{ marginTop: "-5px", }}>
                  {/* 
                    ...
                    <br /><br /> */}
СколькоСкинуть — это сайт, который после тусовки поможет Вам узнать, сколько денег вы должны перевести друг другу. Вы узнаете, как сделать за минимальное число переводов.
<br /><br />
Чтобы вносить данные вместе, ссылку можно можно будет скинуть друзьям. Алгоритм уменьшит количество переводов между людьми, чтобы максимально облегчить процесс расчёта.
<br /><br />
